...
serial_devic_number =  getMachine_addr().strip("SerialNumber")
...
my_string_var.set(tom_type() + " : " + serial_devic_number)
            ...
            if response:
                ...
                with open(os.path.join(get_path(), "terminal.yml"), "w", encoding="utf-8") as t:
                    t.write("terminal:\n" + "\tsoftwareVersion: 1.0.0\n" + "\tmerchant: " + w[5] + "\n" +
                            "\tmerchantId: 453215056520282074\n" + "\tterminalId: " + serial_devic_number + "\n" +
                            "\tterminalCode: 001\n" + "\tstation: " + str(w[4]) + "\n" + "\tstationName: " + w[
                                2] + "\n" + "\toffice: 456\n"
